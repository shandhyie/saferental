...
<link rel="stylesheet" href="assets/http://fonts.googleapis.com/css?family=Open+Sans:400italic,600italic,400,600,700">
...
<div class="container">
  <div class="navbar-header">
    ...
    <!-- Logo -->
      <div id="logo"><img src="assets/images/logo1.png" alt="Saferental" style="height:44px;"> </div>
    </a>
  </div>
  ...
  <div class="container">
    <div class="row room-list fadeIn appear"> 
      ...
      <div class="col-sm-4 toyota-avanza">
        <div class="room-thumb"> <img src="mobil/images/mobil/avanza1.png" alt="room 1" class="img-responsive" />
          <div class="mask">
            <div class="main">
              <h5>Toyota Avanza</h5>
      ...
      <div class="col-sm-4 toyota-innova">
        <div class="room-thumb"> <img src="mobil/images/mobil/innova1.png" alt="room 2" class="img-responsive" />
          <div class="mask">
            <div class="main">
              <h5>Toyota Innova</h5>
      ...
      <div class="col-sm-4 toyota-alphard">
        <div class="room-thumb"> <img src="mobil/images/mobil/alphard1.png" alt="room 3" class="img-responsive" />
          <div class="mask">
            <div class="main">
      ...
      <div class="col-sm-4 honda-jazz">
        <div class="room-thumb"> <img src="mobil/images/mobil/jazz1.png" alt="room 4" class="img-responsive" />
          <div class="mask">
            <div class="main">
              <h5>Honda Jazz</h5>
